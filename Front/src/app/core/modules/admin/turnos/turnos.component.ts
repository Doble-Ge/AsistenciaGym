...
export class TurnosComponent implements OnInit {
  ...
  mostrarTurnoCliente(idTurno:number,descripcionTurno:string,horario:string,idCliente:number,nombreCliente:string,apellidoCliente:string){
//el horario tiene que ir como string al back
    this.mostrarForm=true;
    //this.camposForm.nombre=nombreCliente;
    //this.camposFormTurnosCliente.nombre=nombreCliente
    this.auxNombre=nombreCliente
    this.auxApellido=apellidoCliente;
    this.auxDescripcionTurno=descripcionTurno;
    this.auxCliente=idCliente;
    this.auxTurno=idTurno;
    this.auxHorario=horario;
    //console.log("nombre"+this.auxNombre+"apellido:"+this.auxApellido+"turno"+this.auxTurno+"horario"+this.auxHorario+"descripcion"+this.auxDescripcionTurno+""+"cliente"+this.auxCliente);
